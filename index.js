const contentLetterSrart_actived = "Ấn Vào hộp Thư Nhé." //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc bạn có một ngày sinh nhật vui vẻ, tuổi mới tràn đầy niềm vui và hạnh phúc (Sinh Nhật Vui Vẻ ❤️)" //Nội dung của bức thư
...
function createLight(a) {
    ...
    const blurLv = [2, 4];
    const count = a;
    const allDefaultColor = ["red", "pink", "yellow", "orange", "blue"]
